...
import 'package:sincar/fitBirVucud.dart.dart';


import 'fitBiirvucud.dart';
import 'fitKalacam.dart';
                      ...
                      [
                        ...
                        TextButton(
                          ...
                          onPressed: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (context) => fitBirVucud()),
                            );
                          },
                        ),
                      ],
                      ...
                      [
                        ...
                        TextButton(
                          ...
                          onPressed: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (context) => const bizeGuvenin()),
                            );
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child :Row(
                      children:
                      [
                        Icon(Icons.folder_special_sharp,color: Colors.red,),
                        SizedBox(width: 45,),
                        TextButton(

                          child: Text('Premium üyelk',
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child :Row(
                      children:
                      [
                        Icon(Icons.history_sharp,color: Colors.red,),
                        SizedBox(width: 45,),
                        TextButton(
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: Transform(
                    ...
                    child :
                    ElevatedButton(
                      child: Text('uygulama için giriş yapınız ',),
                                ...
                                builder: (context) {
                                  return Column(
                                    children: <Widget>[
                                      ...
                                      Expanded( child: Image.asset('assets/aslanim_$sayi.jpeg',
                                        width: 500,
                                        height: 250,
                                        fit:BoxFit.fill,
                    ...
                    children: <Widget>[
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => const canliDestek()),
                          );
                        },
                      ),
                    ...
                    children: <Widget>[
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => const premiumavantaj()),
                          );
                        },
                      ),
